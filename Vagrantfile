...
#config.vm.box = "mitchellh/boot2docker"
  ...
  #config.vm.box_url = "https://vagrantcloud.com/mitchellh/boot2docker"
  ...
  # end
  #
  #config.vm.provision :shell, inline: "sudo yum install -y docker-io"
  
  config.vm.define "default", primary: true do |default|
    default.vm.network "forwarded_port", guest: 80, host: 8081, autocorrect: true
  end

  config.vm.define "phpNginx" do |phpNginx|
    phpNginx.vm.box = "hashicorp/precise64"
   ...
   phpNginx.vm.provision :docker do |d|
      ...
      d.run "centos-nginx-php5-hhvm", args: "-d -p 80:80 -m 512m", cmd: "/run.sh", image: "centos-nginx-php5-hhvm:latest" ,daemonize: true
  end

    phpNginx.vm.synced_folder folder, "/vagrant"
  end

  config.vm.define :phpMyAdmin do |phpMyAdmin|
    phpMyAdmin.vm.box = "hashicorp/precise64"

    phpMyAdmin.vm.network "forwarded_port", guest: 80, host: 8083, autocorrect: true

    folder = "./centos-mysql-phpmyadmin/"
